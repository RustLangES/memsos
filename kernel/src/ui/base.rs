...
impl<'a> MemsosUI<'a> {
    ...
    pub fn label(&mut self, text: &str) {
        self.ui.add(Label::new(text).with_font(ascii::FONT_10X20));
    }

    pub fn show_alert(&mut self, title: &str, message: &str) {
        self.ui.add(Label::new(title).with_font(ascii::FONT_10X20));
        self.ui
            .add(Label::new(message).with_font(ascii::FONT_10X20));
    }
    ...
    pub fn show_alert_unrecoverable(&mut self, title: &str, message: &str) -> ! {
        ...
        self.ui
            .add(Label::new("Press space to reboot your computer!").with_font(ascii::FONT_10X20));
...
macro_rules! init_ui {
    ($buffer: expr, $info: expr) => {
        unsafe {
            ...
            *UI.get() = Some(MemsosUI::new(buff, $info));
        }
    };
}
